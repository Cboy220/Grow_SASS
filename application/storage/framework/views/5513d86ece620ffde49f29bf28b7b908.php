        ...
        <div class="x-footer row">
            <div class="col-6 x-icons">
                ...
                <button type="button"
                    ...
                    data-url="<?php echo e(url('/leads/analyze-ai/modal?lead_id=' . $lead->lead_id)); ?>"
                    data-ajax-type="GET"
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH D:\Grow_SaaS\application\resources\views/pages/leads/components/kanban/card.blade.php ENDPATH**/ ?>
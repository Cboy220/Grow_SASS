<div class="modal-dialog modal-lg" id="basicModalContainer">
  ...
  <div class="modal-content">
    <div class="modal-header" id="basicModalHeader">
      <h3 class="modal-title"><i class="fa-solid fa-wand-magic-sparkles"></i><span>AI Project Analysis - <?php echo e($project->project_title ?? 'Project'); ?></span></h3>
        ...
        <ul class="nav nav-tabs" id="aiAnalysisTabs" role="tablist">
          <li class="nav-item">
            <a class="nav-link active js-ajax-ux-request" id="tasks-tab" data-toggle="tab" href="#analysis-content" role="tab" 
               data-url="<?php echo e(url('/projects/'.$project->project_id.'/analyze-ai/tasks')); ?>"
               data-ajax-type="GET"
          ...
          <li class="nav-item">
            <a class="nav-link js-ajax-ux-request" id="team-tab" data-toggle="tab" href="#analysis-content" role="tab"
               data-url="<?php echo e(url('/projects/'.$project->project_id.'/analyze-ai/team')); ?>"
               data-ajax-type="GET"
               data-loading-target="analysis-content"
               data-loading-class="loading">
          ...
          <li class="nav-item">
            <a class="nav-link js-ajax-ux-request" id="billing-tab" data-toggle="tab" href="#analysis-content" role="tab"
               data-url="<?php echo e(url('/projects/'.$project->project_id.'/analyze-ai/billing')); ?>"
               data-ajax-type="GET"
               data-loading-target="analysis-content"
               data-loading-class="loading">
...
<?php /**PATH D:\Grow_SaaS\application\resources\views/pages/projects/views/list/modals/analyze_ai.blade.php ENDPATH**/ ?>
        ...
        <div class="table-responsive list-table-wrapper">
            ...
            <table id="team-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10">
                ...
                <tbody id="team-td-container">
                    <!--ajax content here-->
                    <?php echo $__env->make('pages.team.components.table.ajax', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <!--ajax content here-->
                </tbody>
                <tfoot>
                    <tr>
...
</div><?php /**PATH D:\Grow_SaaS\application\resources\views/pages/team/components/table/table.blade.php ENDPATH**/ ?>
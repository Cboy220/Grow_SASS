        ...
        <div class="modal-content">
            <div class="modal-header" id="basicModalHeader">
                <h3 class="modal-title">
                    ...
                    <span>AI Team Analysis - <?php echo e($team->full_name ?? 'Team Member'); ?></span>
                </h3>
                    ...
                    <ul class="nav nav-tabs" id="aiAnalysisTabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active js-ajax-ux-request" id="weekly-report-tab" data-toggle="tab"
                                ...
                                data-url="<?php echo e(route('team.analyze.ai.base.weekly_report', ['team_id' => $team->id ?? ''])); ?>"
                        ...
                        <li class="nav-item">
                            <a class="nav-link js-ajax-ux-request" id="general-alerts-tab" data-toggle="tab"
                                href="#analysis-content" role="tab"
                                data-url="<?php echo e(route('team.analyze.ai.base.general_alerts', ['team_id' => $team->id ?? ''])); ?>"
                                data-ajax-type="GET" data-loading-target="analysis-content"
                                data-loading-class="loading">
                        ...
                        <li class="nav-item">
                            <a class="nav-link js-ajax-ux-request" id="productivity-tab" data-toggle="tab"
                                href="#analysis-content" role="tab"
                                data-url="<?php echo e(route('team.analyze.ai.base.productivity', ['team_id' => $team->id ?? ''])); ?>"
                                data-ajax-type="GET" data-loading-target="analysis-content"
                                data-loading-class="loading">
...
<?php /**PATH D:\Grow_SaaS\application\resources\views/pages/team/views/modals/team_analysis_modal.blade.php ENDPATH**/ ?>
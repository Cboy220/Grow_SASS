                ...
                <div class="alert alert-info">Unanswered client comments:
                    <ul>
                        <?php $__currentLoopData = $commentsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><?php echo e($comment->comment); ?> <span class="text-muted">(<?php echo e($comment->feedback_created); ?>)</span></li>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="ai-prompt-area d-none">
                    <textarea class="form-control" rows="8" readonly><?php echo e(json_encode($commentsData)); ?></textarea>
                    <small class="text-muted">This prompt will be sent to OpenAI for analysis</small>
                </div>
                <div class="mt-3">
                    <button class="btn btn-sm btn-primary ai-analysis-btn" data-toggle="tooltip" data-placement="top" title="Generate AI-powered analysis" onclick="generateAIAnalysis('comments', <?php echo e($client->client_id); ?>)">
...
</script> <?php /**PATH D:\Grow_SaaS\application\resources\views/pages/clients/components/table/modals/tabs/comments_analysis.blade.php ENDPATH**/ ?>
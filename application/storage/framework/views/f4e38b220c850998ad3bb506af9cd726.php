                ...
                <table id="projects-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contact-list"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="projects_col_id <?php echo e(config('table.tableconfig_column_23')); ?> tableconfig_column_23">
                    ...
                    <tbody id="projects-td-container">
                        <!--ajax content here-->
                        <?php echo $__env->make('pages.projects.views.list.table.ajax', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <!--/ajax content here-->
                    </tbody>
                    <tfoot>
                        <tr>
...
</div><?php /**PATH D:\Grow_SaaS\application\resources\views/pages/projects/views/list/table/table.blade.php ENDPATH**/ ?>
<?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <tr id="client_<?php echo e($client->client_id); ?>" class="<?php echo e($client->pinned_status ?? ''); ?>">
        ...
        <td class="clients_col_account_owner <?php echo e(config('table.tableconfig_column_3')); ?> tableconfig_column_3"
            ...
            <span>
                <a href="javascript:void(0);" class="edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                    ...
                    data-action-ajax-loading-target="commonModalBody"><?php echo e($client->first_name); ?>
        ...
        <td class="col_status <?php echo e(config('table.tableconfig_column_25')); ?> tableconfig_column_25">
            <span
                class="label <?php echo e(runtimeClientStatusLabel($client->client_status)); ?>"><?php echo e(runtimeLang($client->client_status)); ?></span>
        </td>
        <!--tableconfig_column_26 [status]-->
        <td class="col_status <?php echo e(config('table.tableconfig_column_26')); ?> tableconfig_column_26">
            <?php echo e($client->expectation_fulfillment . "%"); ?>

        </td>
        <!--tableconfig_column_27 [status]-->
        <td class="col_status <?php echo e(config('table.tableconfig_column_27')); ?> tableconfig_column_27">
            <?php echo e($client->average_feedback); ?>

        </td>
        <!--tableconfig_column_28 [status]-->
        <td class="col_status <?php echo e(config('table.tableconfig_column_28')); ?> tableconfig_column_28">
            <span class="badge badge-<?php echo e($client->health_status == 'green' ? 'success' : ($client->health_status == 'yellow' ? 'warning' : 'danger')); ?>">
                <?php echo e(ucfirst($client->health_status)); ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row-->
<?php /**PATH D:\Grow_SaaS\application\resources\views/pages/clients/components/table/ajax.blade.php ENDPATH**/ ?>
    ...
    <td class="team_col_action">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <button type="button" title="AI Analysis"
                ...
                data-url="<?php echo e(url('/team/analyze-ai/modal?team_id=' . $team->id)); ?>"
                data-ajax-type="GET"
...
<!--each row--><?php /**PATH D:\Grow_SaaS\application\resources\views/pages/team/components/table/ajax.blade.php ENDPATH**/ ?>
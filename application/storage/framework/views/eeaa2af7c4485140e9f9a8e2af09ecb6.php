...
<tr id="project_<?php echo e($project->project_id); ?>" class="<?php echo e($project->pinned_status ?? ''); ?>">
    ...
    <td class="projects_analyze_ai <?php echo e(config('table.tableconfig_column_23')); ?> tableconfig_column_23">
        <a href="javascript:void(0)"
           class="ai-analysis-btn edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
           data-toggle="modal" data-target="#basicModal"
           data-url="<?php echo e(_url('/projects/'.$project->project_id. "/analyze_ai")); ?>" data-loading-target="basicModal"
    ...
    <td class="projects_col_action actions_column">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <div class="dropdown-menu" aria-labelledby="listTableAction">
                <?php echo $__env->make('pages.projects.views.common.dropdown-menu-team', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </span>
        <?php endif; ?>
...
</style><?php /**PATH D:\Grow_SaaS\application\resources\views/pages/projects/views/list/table/ajax.blade.php ENDPATH**/ ?>
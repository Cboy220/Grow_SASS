<div class="expectations-analysis">
    <div class="card mb-3">
        ...
        <div class="card-body">
            <?php if(!$expectationData['has_recent_progress']): ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="ai-prompt-area d-none">
                    <textarea class="form-control" rows="8" readonly><?php echo e(json_encode($expectationData)); ?></textarea>
                    <small class="text-muted">This prompt will be sent to OpenAI for analysis</small>
                </div>
                <div class="mt-3">
                    <button class="btn btn-sm btn-primary ai-analysis-btn" data-toggle="tooltip" data-placement="top" title="Generate AI-powered analysis" onclick="generateAIAnalysis('expectations', <?php echo e($client->client_id); ?>)">
...
</script> <?php /**PATH D:\Grow_SaaS\application\resources\views/pages/clients/components/table/modals/tabs/expectations_analysis.blade.php ENDPATH**/ ?>
                ...
                <table id="clients-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contact-list"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="col_ai_analysis <?php echo e(config('table.tableconfig_column_29')); ?> tableconfig_column_29" title="AI Analysis">
                            ...
                            <th
                                class="col_account_owner <?php echo e(config('table.tableconfig_column_3')); ?> tableconfig_column_3">
                            ...
                            <?php if(config('visibility.modules.contracts') && config('visibility.role_contracts')): ?>
                                <th
                                    class="col_sum_contracts <?php echo e(config('table.tableconfig_column_18')); ?> tableconfig_column_18">
                            ...
                            <th
                                class="col_count_users <?php echo e(config('table.tableconfig_column_22')); ?> tableconfig_column_22">
                            ...
                            <th
                                class="clients_col_tags <?php echo e(config('table.tableconfig_column_23')); ?> tableconfig_column_23">
                                <a href="javascript:void(0)"><?php echo e(cleanLang(__('lang.tags'))); ?></a>
                            </th>

                            <!--tableconfig_column_24 [category]-->
                            <th
                                class="col_category <?php echo e(config('table.tableconfig_column_24')); ?> tableconfig_column_24">
                            ...
                            <th
                                class="col_expectation_fulfillment <?php echo e(config('table.tableconfig_column_26')); ?> tableconfig_column_26">
                                <a class="js-ajax-ux-request js-list-sorting" id="sort_expectation_fulfillment"
                                    href="javascript:void(0)"
                                    data-url="<?php echo e(urlResource('/clients?action=sort&orderby=expectation_fulfillment&sortorder=asc')); ?>">
                                    <?php echo e(cleanLang(__('lang.expectativas'))); ?><span class="sorting-icons"><i
                                            class="ti-arrows-vertical"></i></span></a>
                            </th>
                            <th
                                class="col_average_feedback <?php echo e(config('table.tableconfig_column_27')); ?> tableconfig_column_27">
                                <a class="js-ajax-ux-request js-list-sorting" id="sort_average_feedback"
                                    href="javascript:void(0)"
                                    data-url="<?php echo e(urlResource('/clients?action=sort&orderby=average_feedback&sortorder=asc')); ?>">
                                    <?php echo e(cleanLang(__('lang.feedback'))); ?><span class="sorting-icons"><i
                                            class="ti-arrows-vertical"></i></span></a>
                            </th>
                            <th
                                class="col_health_stats <?php echo e(config('table.tableconfig_column_28')); ?> tableconfig_column_28">
                                <a class="js-ajax-ux-request js-list-sorting" id="health_status"
                                    href="javascript:void(0)"
                                    data-url="<?php echo e(urlResource('/clients?action=sort&orderby=health_status&sortorder=asc')); ?>">
                                    <?php echo e(cleanLang(__('lang.health'))); ?><span class="sorting-icons"><i
                                            class="ti-arrows-vertical"></i></span></a>
                            </th>
                    ...
                    <tbody id="clients-td-container">
                        <!--ajax content here-->
                        <?php echo $__env->make('pages.clients.components.table.ajax', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <!--ajax content here-->
                    </tbody>
                    <tfoot>
                        <tr>
...
<?php /**PATH D:\Grow_SaaS\application\resources\views/pages/clients/components/table/table.blade.php ENDPATH**/ ?>
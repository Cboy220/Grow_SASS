<div class="modal-dialog modal-xl" id="basicModalContainer">
    <div class="modal-content">
        <div class="modal-header" id="basicModalHeader">
            <h3 class="modal-title"><i class="fa-solid fa-wand-magic-sparkles"></i><span>AI Client Analysis - <?php echo e($client->client_company_name ?? 'Client'); ?></span></h3>
                ...
                <ul class="nav nav-tabs" id="aiAnalysisTabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active js-ajax-ux-request" id="feedback-tab" data-toggle="tab" href="#analysis-content" role="tab"
                           data-url="<?php echo e(route('clients.analyze.ai.feedback', $client->client_id)); ?>"
                           data-ajax-type="GET"
                    ...
                    <li class="nav-item">
                        <a class="nav-link js-ajax-ux-request" id="expectations-tab" data-toggle="tab" href="#analysis-content" role="tab"
                           data-url="<?php echo e(route('clients.analyze.ai.expectations', $client->client_id)); ?>"
                           data-ajax-type="GET"
                           data-loading-target="analysis-content"
                           data-loading-class="loading">
                    ...
                    <li class="nav-item">
                        <a class="nav-link js-ajax-ux-request" id="projects-tab" data-toggle="tab" href="#analysis-content" role="tab"
                           data-url="<?php echo e(route('clients.analyze.ai.projects', $client->client_id)); ?>"
                           data-ajax-type="GET"
                           data-loading-target="analysis-content"
                           data-loading-class="loading">
                    ...
                    <li class="nav-item">
                        <a class="nav-link js-ajax-ux-request" id="comments-tab" data-toggle="tab" href="#analysis-content" role="tab"
                           data-url="<?php echo e(route('clients.analyze.ai.comments', $client->client_id)); ?>"
                           data-ajax-type="GET"
                           data-loading-target="analysis-content"
                           data-loading-class="loading">
...
</script> <?php /**PATH D:\Grow_SaaS\application\resources\views/pages/clients/views/list/modals/analyze_ai.blade.php ENDPATH**/ ?>
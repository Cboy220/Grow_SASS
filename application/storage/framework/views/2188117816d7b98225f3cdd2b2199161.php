<div class="projects-analysis">
    <div class="card mb-3">
        ...
        <div class="card-body">
            <?php if(count($projectData['overdue']) > 0): ?>
                <div class="alert alert-danger">Overdue projects:
                    <ul>
                        <?php $__currentLoopData = $projectData['overdue']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><?php echo e($proj->project_title); ?> (Due: <?php echo e($proj->project_date_due); ?>)</li>
            ...
            <?php endif; ?>
            <?php if(count($projectData['upcoming']) > 0): ?>
                <div class="alert alert-info">Projects with upcoming deadlines:
                    <ul>
                        <?php $__currentLoopData = $projectData['upcoming']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><?php echo e($proj->project_title); ?> (Due: <?php echo e($proj->project_date_due); ?>)</li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="ai-prompt-area d-none">
                    <textarea class="form-control" rows="8" readonly><?php echo e(json_encode($projectData)); ?></textarea>
                    <small class="text-muted">This prompt will be sent to OpenAI for analysis</small>
                </div>
                <div class="mt-3">
                    <button class="btn btn-sm btn-primary ai-analysis-btn" data-toggle="tooltip" data-placement="top" title="Generate AI-powered analysis" onclick="generateAIAnalysis('projects', <?php echo e($client->client_id); ?>)">
...
</script> <?php /**PATH D:\Grow_SaaS\application\resources\views/pages/clients/components/table/modals/tabs/projects_analysis.blade.php ENDPATH**/ ?>
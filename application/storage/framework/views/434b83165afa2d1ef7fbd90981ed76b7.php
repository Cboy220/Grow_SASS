...
<div class="team-analysis">
    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card bg-primary text-white">
                <div class="card-body text-center">
                    <h4 class="text-white font-weight-bold"><?php echo e($teamMembers->count()); ?></h4>
        ...
        <div class="col-md-3">
            <div class="card bg-warning text-white">
                <div class="card-body text-center">
                    <h4 class="text-white font-weight-bold"><?php echo e($overloadedMembers->count()); ?></h4>
        ...
        <div class="col-md-3">
            <div class="card bg-info text-white">
                <div class="card-body text-center">
                    <h4 class="text-white font-weight-bold"><?php echo e($unassignedMembers->count()); ?></h4>
        ...
        <div class="col-md-3">
            <div class="card bg-success text-white">
                <div class="card-body text-center">
                    <h4 class="text-white font-weight-bold"><?php echo e($teamMembers->count() - $overloadedMembers->count() - $unassignedMembers->count()); ?></h4>
    ...
    <div class="team-workload">
        <?php if($overloadedMembers->count() > 0): ?>
        <div class="card mb-3">
            <div class="card-header bg-warning text-white">
                <h6><i class="fas fa-exclamation-triangle"></i> Overloaded Team Members (<?php echo e($overloadedMembers->count()); ?>)</h6>
            </div>
            <div class="card-body">
                <div class="list-group">
                    <?php $__currentLoopData = $overloadedMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <div class="list-group-item">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                <img src="<?php echo e(getUsersAvatar($member->avatar_directory ?? '', $member->avatar_filename ?? '')); ?>" class="rounded-circle mr-3" width="40" height="40" alt="<?php echo e($member->first_name ?? ''); ?>">
                                <div>
                                    <h6 class="mb-1"><?php echo e($member->first_name ?? ''); ?> <?php echo e($member->last_name ?? ''); ?></h6>
                                    <small class="text-muted"><?php echo e($member->email ?? ''); ?></small>
                                </div>
                            </div>
                            <div class="text-right">
                                <span class="badge badge-warning"><?php echo e($activeTasksCount); ?> Active Tasks</span>
                                <br>
                                <small class="text-muted">Total: <?php echo e($totalTasksCount); ?> tasks</small>
                            </div>
                        </div>
                    </div>
        ...
        <?php if($unassignedMembers->count() > 0): ?>
        <div class="card mb-3">
            <div class="card-header bg-info text-white">
                <h6><i class="fas fa-user-plus"></i> Unassigned Team Members (<?php echo e($unassignedMembers->count()); ?>)</h6>
            </div>
            <div class="card-body">
                <div class="list-group">
                    <?php $__currentLoopData = $unassignedMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="list-group-item">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                <img src="<?php echo e(getUsersAvatar($member->avatar_directory ?? '', $member->avatar_filename ?? '')); ?>" class="rounded-circle mr-3" width="40" height="40" alt="<?php echo e($member->first_name ?? ''); ?>">
        ...
        <div class="card mb-3">
            <div class="card-header bg-primary text-white">
                <h6><i class="fas fa-users"></i> All Team Members (<?php echo e($teamMembers->count()); ?>)</h6>
            </div>
            <div class="card-body">
                <div class="list-group">
                    ...
                    <div class="list-group-item">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="text-right">
                                ...
                                <?php else: ?>
                                    <span class="badge badge-success"><?php echo e($activeTasksCount); ?> Active Tasks</span>
                                <?php endif; ?>
                                <br>
                                <small class="text-muted">Total: <?php echo e($totalTasksCount); ?> tasks</small>
                            </div>
     ...
     <div class="ai-analysis-section mb-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mt-3">
                    <button class="btn btn-sm btn-primary ai-analysis-btn" data-toggle="tooltip" data-placement="top" title="Generate AI-powered analysis" onclick="generateAIAnalysis('team', <?php echo e($project->project_id); ?>)">
...
</style> <?php /**PATH D:\Grow_SaaS\application\resources\views/pages/projects/views/list/modals/tabs/team_analysis.blade.php ENDPATH**/ ?>
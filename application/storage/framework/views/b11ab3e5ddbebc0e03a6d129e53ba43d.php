        ...
        <div class="card-body">
            ...
            <?php else: ?>
                <table class="table table-sm table-bordered mb-0">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $feedbackList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($fb->feedback_created); ?></td>
                            <td><?php echo e($fb->total_marks); ?></td>
                            <td><?php echo e($fb->comment); ?></td>
                        </tr>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="ai-prompt-area d-none">
                    <textarea class="form-control" rows="8" readonly><?php echo e(json_encode($feedbackData)); ?></textarea>
                    <small class="text-muted">This prompt will be sent to OpenAI for analysis</small>
                </div>
                <div class="mt-3">
                    <button class="btn btn-sm btn-primary ai-analysis-btn" data-toggle="tooltip" data-placement="top" title="Generate AI-powered analysis" onclick="generateAIAnalysis('feedback', <?php echo e($client->client_id); ?>)">
...
</script> <?php /**PATH D:\Grow_SaaS\application\resources\views/pages/clients/components/table/modals/tabs/feedback_analysis.blade.php ENDPATH**/ ?>